...
#define kBankDataOfNearByMembers @"没有数据哦，亲"
...
#pragma mark 配置项
#define kPayType  @[@"一次性付款",@"公积金贷款",@"商业贷款",@"组合贷款",@"分期付款"]

#define kTagColors @[UIColorHex(0xffc42f),UIColorHex(0x02b0f0),UIColorHex(0xff6158),UIColorHex(0x29d043),UIColorHex(0x30cda0)];
